...
//! recorded that fdk-aac is *not* bit-identical across architectures, because each
//! architecture swaps in its own fixed-point primitives and the two sets round differently.
//!
